...
const sendMessageFromUser = async (req, res) => {
    try {
      ...
      console.error("Error in sendMessageFromUser:", error.message);
...
const getMessagesForUser = async (req, res) => {
    try {
      ...
      // Query untuk mencari pesan di mana doctorId sebagai pengirim atau penerima
      const query = {
        $or: [
      ...
      // Menjalankan query dan mengurutkan berdasarkan waktu
      ...
      console.error("Error in getMessagesByDoctor:", error.message);
      res.status(500).json({ success: false, message: error.message });
    }
  };
